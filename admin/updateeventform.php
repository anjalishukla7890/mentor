                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="updateeventdata.php" enctype="multipart/form-data">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="joining_fees" class="form-control" value="<?php echo $data['joining_fees']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="date_from" class="form-control" value="<?php echo $data['date_from']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 col-form-label">Date To</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="date_to" class="form-control" value="<?php echo $data['date_to']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 col-form-label">Time From</label>
                                    <div class="col-sm-10">
                                        <input type="time" name="time_from" class="form-control" value="<?php echo $data['time_from']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 col-form-label">Time To</label>
                                    <div class="col-sm-10">
                                        <input type="time" name="time_to" class="form-control" value="<?php echo $data['time_to']; ?>">
                                    </div>
                                </div>                                
