        ...
        <section class="section">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="website_insertform.php" class="btn btn-primary" style="float:right; margin-top:65px; margin-left:10px;">Insert New Data</a>
                            <h5 class="card-title">Website Pages</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        if (mysqli_num_rows($run) > 0) {
                                            ...
                                            if ($page > 2) {
                                                echo '<li class="page-item"><a class="page-link" href="websitepages.php?page=1&limit=' . $limit . '&sortby='.$sort_sql.'"> First </a></li>';
                                            }

                                            if ($page > 1) {
                                                echo '<li class="page-item"><a class="page-link" href="websitepages.php?page=' . ($page - 1) . '&limit=' . $limit . '&sortby='.$sort_sql.'"> Prev </a></li>';
                                            }
                                            ...
                                            for ($i = 1; $i <= $total_page; $i++) {
                                                ...
                                                if ($i == $page || ($i > ($page - 3) && $i < $page) || ($i < ($page + 3) && $i > $page)) {
                                                    # code...
                                                    echo '<li class="page-item' . $active . '"><a class="page-link" href="websitepages.php?page=' . $i . '&limit=' . $limit . '&sortby='.$sort_sql.'">' . $i . '</a></li>';
                                                }
                                            }

                                            if ($total_page > $page) {
                                                echo '<li class="page-item"><a class="page-link" href="websitepages.php?page=' . ($page + 1) . '&limit=' . $limit . '&sortby='.$sort_sql.'">Next</a></li>';
                                            }

                                            if ($total_page != $page) {
                                                echo '<li class="page-item"><a class="page-link" href="websitepages.php?page=' . $total_page . '&limit=' . $limit . '&sortby='.$sort_sql.'">Last</a></li>';
                                            }
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($_GET["search"])) :
                                        $search_sql = " AND (name LIKE '%" . $_GET["search"] . "%' || url_ LIKE '%" . $_GET["search"] . "%' || type LIKE '%" . $_GET["search"] . "%' )";
                                    endif;
                                    ...
                                    $sql = "SELECT * FROM websitepages WHERE 1 $search_sql $sort_sql  LIMIT  $offset, $limit ";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td align="left"><?php echo $data['url_']; ?></td>
                                                <td align="left"><?php echo $data['type']; ?></td>
                                                <td><img height="60px" src="<?php echo "../images/" . $data['image']; ?>"></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="update_webpageform.php?page=<?php echo $page; ?>&id=<?php echo $data['id']; ?>">Edit</a>
                                                        <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="delete_webpagedata.php?page=<?php echo $page; ?>&id=<?php echo $data['id']; ?>">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                    <?php
                            ...
                            <div style="text-align:right;"><b>
                                    ...
                                    Of <?php echo mysqli_num_rows(mysqli_query($conn, 'SELECT * FROM websitepages')); ?> entries
                                </b>
                            </div>
                            ...
                            <script>
                                function togglestatus(id, status) {
                                    $.ajax({ //create an ajax request to display.php
                                        type: "GET",
                                        url: "websitepagestatus.php?id=" + id + '&status=' + status,
