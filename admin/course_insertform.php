                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="course_insertdata.php" enctype="multipart/form-data">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="pricing" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="availableseats" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="view" class="form-control" value="">
                                    </div>
                                </div>                               
